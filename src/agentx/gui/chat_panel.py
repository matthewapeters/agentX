...
class ChatPanel:
    ...
    def create(self) -> None:
        ...
        # Bind copy shortcuts and context‑menu
        self._widgets.output_entries_frame.bind("<Control-c>", self._copy_selected_output)
        self._widgets.output_entries_frame.bind("<Button-3>", self._show_context_menu)
