...
class TestStreamingExecutor:
    ...
    def test_progress_updates_generation(self):
        ...
        updates = list(self.executor.execute_with_streaming(
    ...
    def test_progress_callback(self):
        ...
        list(self.executor.execute_with_streaming(
            self.mock_tool_executor,
            "test_tool",
            {},
...
class TestProgressUpdate:
    ...
    def test_progress_update_creation(self):
        ...
        update = ProgressUpdate(
            type=ProgressType.PROGRESS.value,
            tool_name="test_tool",
            current=50,
            total=100,
            percent=50.0
...
class TestStreamingToolChain:
    ...
    def test_execute_chain(self):
        ...
        updates = list(self.chain.execute_chain(
            self.executor,
            self.mock_tool_executor
        ))
