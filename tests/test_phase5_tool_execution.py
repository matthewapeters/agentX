...
class TestClientToolExecutor:
    ...
    def test_write_file(self):
        ...
        result = self.executor.execute("write_file", {"path": str(test_file), "content": content})
    ...
    def test_list_directory(self):
        ...
        result = self.executor.execute("list_directory", {"path": self.temp_dir.name})
    ...
    def test_get_file_info(self):
        ...
        result = self.executor.execute("get_file_info", {"path": str(test_file)})
    ...
    def test_search_files(self):
        ...
        result = self.executor.execute("search_files", {"path": self.temp_dir.name, "pattern": "*.py"})
    ...
    def test_append_file(self):
        ...
        self.executor.execute("write_file", {"path": str(test_file), "content": "Line 2\n", "append": True})
    ...
    def test_path_security(self):
        ...
        try:
            result = self.executor.execute("read_file", {"path": "../../etc/passwd"})
...
def test_phase5_integration():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Search files
        search = executor.execute("search_files", {"path": temp_dir, "pattern": "*.txt"})
