...
class TestServerToolExecutor:
    ...
    def test_get_available_tools(self):
        ...
        mock_tools = [
            {"type": "function", "function": {"name": "analyze_syntax", "description": "Analyze code syntax"}}
        ]
    ...
    def test_tool_result_formatting(self):
        ...
        result = self.executor._format_tool_result(
            tool_name="test_tool", status="success", message="Tool executed", result={"data": "value"}
        )
...
class TestAdvancedToolRegistry:
    ...
    def test_registry_initialization(self):
        ...
        self.mock_bridge.get_available_tools.return_value = [
            {"type": "function", "function": {"name": "analyze_syntax", "description": "Analyze code"}}
        ]
    ...
    def test_list_tools_all(self):
        ...
        self.mock_bridge.get_available_tools.return_value = [
            {"type": "function", "function": {"name": "analyze_syntax", "description": "Code analysis"}}
        ]
...
def test_session_with_advanced_tools():
    ...
    with patch("agentx.session.GUIManager") as mock_gui_class:
        ...
        # advanced_tools was superseded by _tool_dispatcher in a later refactor
        assert session._tool_dispatcher is not None
...
def test_advanced_tool_categories():
    ...
    code_tools = {
        name: tool
        for name, tool in CodeAnalysisTool.TOOLS.items()
