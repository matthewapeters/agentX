...
class TestMessageModel:
    ...
    def test_create_tool_call_message(self):
        ...
        msg = tool_call_message(tool_name="cst_analyze", tool_input={"file_path": "/src/main.py"}, tool_id="call_123")
    ...
    def test_create_tool_result_message(self):
        ...
        msg = tool_result_message(tool_id="call_123", content="Analysis complete: 5 functions found")
    ...
    def test_message_with_attachment(self):
        ...
        attachment = Attachment(file_path="/path/to/file.py", content="print('hello')", mime_type="text/x-python")
...
class TestResponseChunkModel:
    ...
    def test_create_content_chunk(self):
        ...
        chunk = ResponseChunk(chunk_type=ChunkType.CONTENT, content="Hello")
    ...
    def test_create_thinking_chunk(self):
        ...
        chunk = ResponseChunk(chunk_type=ChunkType.THINKING, content="Let me analyze this...")

        assert chunk.chunk_type == ChunkType.THINKING

    def test_create_tool_call_chunk(self):
        """Test creating a tool call chunk."""
        chunk = ResponseChunk(chunk_type=ChunkType.TOOL_CALL, tool_name="cst_analyze", tool_input={"file": "main.py"})
    ...
    def test_create_error_chunk(self):
        ...
        chunk = ResponseChunk(chunk_type=ChunkType.ERROR, content="Connection failed", error_code="CONN_ERR")
    ...
    def test_from_ollama_chunk(self):
        ...
        ollama_chunk = {"message": {"content": "Hello"}, "done": False}
    ...
    def test_done_chunk_from_ollama(self):
        ...
        ollama_chunk = {"message": {"content": ""}, "done": True}
...
class TestToolSystem:
    ...
    def test_create_tool_request(self):
        ...
        request = ToolRequest(tool_name="file_read", tool_input={"path": "/src/main.py"}, request_id="req_001")
    ...
    def test_create_tool_response_error(self):
        ...
        response = ToolResponse(request_id="req_001", success=False, error="File not found: /src/main.py")
...
class TestConfiguration:
    ...
    def test_unified_config_from_dict(self):
        ...
        data = {"agentx": {"ollama_model": "codellama", "screen_side": "right"}, "agentix": {"debug": True}}
...
class TestClientServerCommunication:
    ...
    def test_context_to_api_request(self):
        ...
        payload = ctx.to_payload(model="llama3.2", stream=True, options={"temperature": 0.7})
    ...
    def test_tool_request_serialization(self):
        ...
        request = ToolRequest(
            tool_name="cst_analyze", tool_input={"file_path": "/src/main.py", "depth": 3}, request_id="tool_001"
        )
    ...
    def test_tool_response_serialization(self):
        ...
        response = ToolResponse(
            request_id="tool_001", success=True, result={"functions": ["main", "helper"], "count": 2}
        )
