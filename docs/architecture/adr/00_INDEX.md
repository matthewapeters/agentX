...
- [0014 - Tidal: Hypothesis-Grounded Consolidation over Wavefront Dispatch](0014-tidal-hypothesis-grounded-consolidation.md) — design-only, not yet implemented. A two-tier problem-solving strategy: Tier 1 is wavefront's continuous dispatch, unchanged; Tier 2 is a periodic, non-pruning hypothesis-tracking consolidation cycle (Likelihood, Evidence+Stance, disjunctive Resolution Criteria reusing ADR 0010's satisfied/refuted/abstained vocabulary) realized as a dedicated `hooks.SyncHook` against `ConversationCore` with zero changes to that loop. Extends ADR 0008/0010/0012/0013 rather than superseding any of them; blocked on ADR 0013 Open Questions 2 and 4 for sub-session attachment.
