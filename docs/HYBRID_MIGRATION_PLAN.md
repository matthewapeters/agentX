...
- Demo UX refinement: `./bin/agentx --demo` now opens a split tmux controller with a live core mirror pane on the right; the smoke gate uses `--demo-headless` to keep artifact validation deterministic.
